...
<body style="margin:0;padding:0;background-color:#f4f4f4;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
  @php
    ...
    $publicationUrl = $publication->external_url
      ?: ($siteUrl . '/pressroom/publications/' . $publication->slug);
  @endphp
          ...
          <tr>
            <td style="background:#1B3A2D;padding:28px 40px;text-align:left;">
              <p style="margin:0;color:#ffffff;font-size:18px;font-weight:700;letter-spacing:0.5px;">
                Invest Lagos &middot; New Publication
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px 40px 16px;color:#1a1a1a;font-size:15px;line-height:1.7;">
              ...
              @if($publication->category)
                <p style="margin:0 0 16px;font-size:12px;text-transform:uppercase;letter-spacing:1px;color:#3EBF75;font-weight:700;">
